class Refund extends React.Component {
  ...
  async handleRefund() {
    ...
    const argAmount = StellarSdk.nativeToScVal(100, { type: 'i128' });
    ...
    return (
      <div>
        <fieldset>
          ...
          <button onClick={this.handleRefund} disabled={this.props.accountContractId == null}>Refund (Bundler 👈 Account)</button>
        </fieldset>
      </div>
    );
  }
